...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative flex h-screen w-full flex-col overflow-hidden bg-[#050508]">
      ...
      >
        ...
        <div className="flex items-start justify-between">
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-end pt-2">
            <span className="text-xs md:text-sm font-bold uppercase tracking-[0.4em] text-accent">
              Strategic Operator
            </span>
            <span className="mt-1 text-[10px] md:text-xs uppercase tracking-[0.25em] text-white/40">
              Founder & Builder
            </span>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <span className="text-base md:text-lg font-bold text-white tracking-[0.2em] uppercase">
              Entrepreneur
            </span>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="text-base md:text-lg font-bold text-white tracking-[0.2em] uppercase leading-tight">
        ...
        <div className="flex items-end justify-between">
          ...
          >
            <span className="text-[10px] md:text-xs font-medium uppercase tracking-[0.5em] text-white/30">
              Scroll
            </span>
            <motion.div 
              animate={{ y: [0, 8, 0] }}
      ...
      {/* FRAME BORDERS */}
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent z-30" />
      <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent z-30" />
      <div className="absolute inset-y-0 left-0 w-px bg-gradient-to-b from-transparent via-white/[0.05] to-transparent z-30" />
      <div className="absolute inset-y-0 right-0 w-px bg-gradient-to-b from-transparent via-white/[0.05] to-transparent z-30" />
    </section>
  );
};
